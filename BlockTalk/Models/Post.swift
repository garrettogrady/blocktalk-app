...
extension Post {
    ...
    private static func sample(_ username: String, _ number: Int, _ text: String,
                               ...
                               pin: Bool = false, image: String? = nil) -> Post {
        Post(
            id: UUID(),
            userId: UUID(),
    ...
    static let sampleFeed: [Post] = [
        ...
        sample("norfolkghost", 2118, "the croissant deli has set up a little folding chair and a sign that says \"fresh at 3am\" and i need an investigation.", agoMin: 45, score: 41, replies: 5, pin: true),
        ...
        sample("BlockTalker", 3442, "whoever is busking on this corner — please. learn one (1) other song. it's been \"wonderwall\" for six straight weekends.", agoMin: 120, score: 88, replies: 9, pin: true),
        ...
        sample("forsyth", 1777, "three years. same Barbour jacket. same cigarette. either a ghost or me.", agoMin: 180, score: 132, replies: 14, pin: true),
        ...
        sample("attorney_st", 1558, "unmarked black sedan, hazards on, 90 minutes. either a movie shoot or the prologue to a kidnapping.", agoMin: 300, score: 67, replies: 8, pin: true),
        sample("henrystreet", 2341, "Solid gym, think they might want to look into selling deoderant in addition to pre-work out, place is a zoo", agoMin: 60, score: 54, replies: 6, pin: true),
