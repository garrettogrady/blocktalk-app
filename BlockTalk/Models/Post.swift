...
extension Post {
    ...
    static let sampleFeed: [Post] = [
        ...
        sample("ratking", 1209, "rat ran across my foot on Orchard tonight. paused. looked up at me. continued. it's HIS building actually.", agoMin: 11, score: 500, replies: 12),
        ...
        sample("henrystreet", 2341, "Solid gym, think they might want to look into selling deoderant in addition to pre-work out, place is a zoo", agoMin: 60, score: 450, replies: 5, pinId: Pin.clintonDelancey),
